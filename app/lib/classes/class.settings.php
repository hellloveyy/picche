...
class Settings {
	...
	public static function getChevereto() {
		$api = 'https://moelori.cn/api/';
		return [
			'edition'	=> G_APP_NAME,
			'version'	=> G_APP_VERSION,
			'source'	=> [
				'label'	=> !defined('G_APP_GITHUB_REPO_URL') ? 'moelori.cn/panel/downloads' : (G_APP_GITHUB_OWNER . '/' . G_APP_GITHUB_REPO),
				'url'	=> !defined('G_APP_GITHUB_REPO_URL') ? 'https://moelori.cn/panel/downloads' : G_APP_GITHUB_REPO_URL,
			],
			'api'	=> [
