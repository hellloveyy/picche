				...
				<div class="input-label">
				  <div class="checkbox-label">
				    <label for="signup-accept-terms-policies">
				      <input type="checkbox" name="signup-accept-terms-policies" id="signup-accept-terms-policies" value="1" required><?php _se('I agree to the %terms_link and %privacy_link', ['%terms_link' => '<a href="' . G\get_base_url('page/tos') . '">'. _s('terms') .'</a>', '%privacy_link' => '<a href="' . G\get_base_url('page/privacy') . '">' . _s('privacy policy'). '</a>']); ?>
				    </label>
				  </div>
