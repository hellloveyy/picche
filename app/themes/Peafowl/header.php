...
<!--                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
                                                                                              B@B@B@B@BM7,                                              
                                                                                         .:71B@B@B@B@@@B@B@S:                                           
                                                                                       5B@B@B@B@B@BqrOB@B@B@BB                                          
                                                                                     B@@@B@B@B@B@@@BPiiu@B@B@@@B2                                       
                                                                                   rB@BU1JrvUOB@@@@@@@NLB@B@B@B@B                                       
                                                                                   F:    :Yr    r@@B@B@B@B@B@B@@7                                       
                                        .i...,.                                  7MJ:  :Ji:i.     8@@@B@B@B@B@@@,                                       
                                   .:,JL::...,::i;i.                             :, i.  :i:      r@r5B@B@B@B@B@@.                                       
                                 :i: 7:           .ii:                            Xu    rLUE:    GB@5PB@M@B@@@B5                                        
                               ,:   J.               .Lr                          r..       .     7XB8@vi.@@@B@                                         
                             ..    S                   vX:                       : .               @M:Xki:M@B@B                                         
                            ir    Z               ..::. .Zv                       ,: .             ..@8Ei L@@BJ                                         
                           7  r: P,        :    .:,,      1v                      :X::.i             r. i@B@7                                           
                          7,   .qr   ::    :  ,            Li                     .    :           ,   X@@@:                                            
                         ,;    .:   .:v7    i ,:            N                    ,S:i::X0, :,       7X@@B@B@Li  .,                                      
                         v     i.    .  r:  :r ..      ,i:  Lu                   7r      vi        :L.@@@BOiivk5@B@B@Y.                                 
                        :r     i      :: ,i  .  v7    r: u  :@                       .           .r@L ,i8@          rMB2;u.                             
                        u:  .  .   .:  .i  :  ,  0r   .X .7 .B.                            :M2FLPO@B     ,@                                             
                        S7   ..i.  , .: ,i  ,: 7  7.   k, , .@.                  . .   .r@B@U::.  P7      i@                                            
                        SX          :  J.,7   :,.  ..  r  :,,B                    :@@80B@B@F      7        :q:                                          
                        i@           :  :,,:   ,:.   : 7. :i @.                    .Fr   ,Mu. .. :.          EBZ:                                       
                         B:       :.  :  .i,Ui   i   ,Fu  .i.O                       vu    7.    i        ,:::7@Eu                                      
                         YB     , ..:. ..  . i.            ,L:                      : .     8.   :     :rr,  ..7UNBP                                    
                          @v .::i: : :r .7,   :.      .    ,7                       :.    :jvv      ,uj:   :vi:.. iB@                                   
                          .@r    i. i  :.,:            .   O7                           :GZ8JL    :GX.  :r:.        r@v                                 
                            M1. . i,                      i1                          :rBLr7u   .P8.  .:.             @i                                
                             YMF:  ,7, ::                 v,                        ., 7 ir@L  UM:  :i                r7                                
                               78E;  ri...                2v                       u: j. .7q .B5  iLv                  M                                
                                 :kMurv7:i:rL,            i8                      E, 7.:.i@JUB, .@Yk                   @i                               
                                    .i7j57LiijL.           ,7                    Mi :ii7iG@M;  .@ Y                    Zr                               
                                           i. .j2r          .L.                 kU. JL  :JL    @ .u i                  57                               
                                            L.   P8           77               :@:  rB 7@7    @i SrY                   vv                               
                                             Y:   YM           :7.             @L:  i: :     85 M,Y:                   Fv                               
                                              k.   7@,           ,r           GYi  i        :M .@ 7                    B:                               
                                              ,5    ,u8L.         .ur        Mkj. L. .      U  U0.     .               @                                
                                               7F  .  .:i           r2,     O ;Y v  :      ..  B@,     .              8M                                
                                                5j , .  L:            Lu   X  B.:  ,.          @q     .:             7B8                                
                                                 G; . .  17            .1Sq  LM::  7          FB,     :,           7: Oq                                
                                                  G. ,    YU             :qJu.  j F          .Bi      :.         kZ, r5q                                
                                                  .O       rN              :@5  k7,         .S        ,        7Nr   BiM                                
                                                   vU   .   ,Mr              iMZM.         :1                iXL    uPiO                                
                                                    @.  .     EX               :8O:       rF               .i.     .MuFr                                
                                                    :@   . .   L@.               .Sqi    iZ               ,r       18J7:                                
                                                     Nr   . .   ,Br                 qM.  B               .L       G8Y:,                                 
                                                      0    ..     X5                 :BSE:              :U      L0: r :                                 
                            ...
                            <div class="input">
														  <div class="checkbox-label">
														    <label for="signup-accept-terms-policies-top">
														      <input type="checkbox" name="signup-accept-terms-policies" id="signup-accept-terms-policies-top" value="1" required><?php _se('I agree to the %terms_link and %privacy_link', ['%terms_link' => '<a href="' . G\get_base_url('page/tos') . '">'. _s('terms') .'</a>', '%privacy_link' => '<a href="' . G\get_base_url('page/privacy') . '">' . _s('privacy policy'). '</a>']); ?>
														    </label>
														  </div>
														</div>
                        </form>
