...
(function() {
	var PUP = {
		...
		vendors: {
			...
			XF2: {
				// I left commented out the stuff needed for making this work inside froala toolbar, but on window resize it will revert your sibling element pos. Is just a limitation of this kind of implementation
				settings: {
			 		autoInsert: 'html-embed-medium',
			   	containerClass: 1,
			   	buttonClass: 1,
					...
					html: ' <a %x class="%bClass button button--link button button--icon"><span class="%iClass">%iconSvg</span><span class="button-text">%text</span></a> ',
			   	// sibling: '[data-cmd="clearFormatting"]',
			   	sibling: '.js-attachmentUpload',
					siblingPos: 'before',
					css: '.%bClass .%iClass{display:inline-block;vertical-align:middle;margin-right:.2em;vertical-align:-.1em}.%bClass .%iClass svg{font-size:1em;display:block;width:1em;height:1em;fill:currentColor}',
